<?php
	...
	if(isset($_GET['ID'])){
		...
		header("Location: http://{$_SERVER['HTTP_HOST']}/Project3/dataPuppies.php");
	}
		...
		<form action="" enctype="multipart/form-data" method="POST">
				<table>
					...
					<tr>
						...
						<input type="submit" name="back" value='Back<?php if(isset($_POST["back"])){ header("Location: http://{$_SERVER['HTTP_HOST']}/Project3/dataPuppies.php");}?>'/>
					</td>
					</tr>
				</table>
		</form>
